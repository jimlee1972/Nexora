...
static_assert(std::is_standard_layout_v<NexoraGameplayHostV3>);
static_assert(std::is_standard_layout_v<NexoraGameModuleV3>);
static_assert(std::is_standard_layout_v<NexoraGameModuleV2>);
static_assert(std::is_standard_layout_v<NexoraEntitySpawnDescriptor>);
static_assert(std::is_standard_layout_v<NexoraInputSnapshot>);
static_assert(std::is_standard_layout_v<NexoraRaycastHit>);
static_assert(std::is_standard_layout_v<NexoraFrameDiagnostics>);
...
static_assert(offsetof(NexoraGameplayHostV3, struct_size) == 0);
static_assert(offsetof(NexoraGameModuleV3, struct_size) == 0);
static_assert(offsetof(NexoraGameModuleV2, struct_size) == 0);
static_assert(NEXORA_GAMEPLAY_ABI_VERSION == 3U);

int main() {
  NexoraGameModuleV3 module{};
  module.struct_size = sizeof(module);
  module.abi_version = NEXORA_GAMEPLAY_ABI_VERSION;
  return module.struct_size >= sizeof(std::uint32_t) * 2 && module.abi_version == 3 ? 0 : 1;
}
