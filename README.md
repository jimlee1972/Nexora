...
| [V2 Complete Plan](Roadmap/en/Cross-platform_3D_Engine_V2_Complete_Plan_v1_4.md) | **15%** | V2-M0 migration and V2-M1 portable production-toolchain gates are accepted; M2–M12 remain open. |
| [V2 AI Implementation Plan](Roadmap/en/Cross-platform_3D_Engine_V2_AI_Implementation_Technology_and_System_Plan_v1_2.md) | **15%** | V2-M0 and V2-M1 are accepted with deterministic migration and toolchain gates; M2–M12 remain open. |
...
| [V2 完整規劃書](Roadmap/zh-TW/跨平台3D_Engine_V2_完整規劃書_v1_4.md) | **15%** | V2-M0 migration 與 V2-M1 portable production-toolchain gate 已驗收；M2–M12 尚待完成。 |
| [V2 AI 施工規劃](Roadmap/zh-TW/跨平台3D_Engine_V2_AI施工技術與系統規劃_v1_2.md) | **15%** | V2-M0 與 V2-M1 已以 deterministic migration 及 toolchain gate 驗收；M2–M12 尚待完成。 |
