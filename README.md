...
| [V2 Complete Plan](Roadmap/en/Cross-platform_3D_Engine_V2_Complete_Plan_v1_4.md) | **23%** | ✅ V2-M0 through ✅ V2-M2 are accepted; the V2-M3 CPU reference pipeline is implemented, but native GPU execution gates remain open. |
| [V2 AI Implementation Plan](Roadmap/en/Cross-platform_3D_Engine_V2_AI_Implementation_Technology_and_System_Plan_v1_2.md) | **23%** | ✅ V2-M0 through ✅ V2-M2 are accepted; V2-M3 has reference culling and indirect-command generation but is not yet accepted. |
...
| [V2 完整規劃書](Roadmap/zh-TW/跨平台3D_Engine_V2_完整規劃書_v1_4.md) | **23%** | ✅ V2-M0 至 ✅ V2-M2 已驗收；V2-M3 CPU reference pipeline 已實作，但 native GPU execution gate 仍待完成。 |
| [V2 AI 施工規劃](Roadmap/zh-TW/跨平台3D_Engine_V2_AI施工技術與系統規劃_v1_2.md) | **23%** | ✅ V2-M0 至 ✅ V2-M2 已驗收；V2-M3 已有 reference culling 與 indirect-command generation，但尚未驗收。 |
