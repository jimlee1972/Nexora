...
The shell tracks the surface's live client extent and DPI scale, recreates its UI target after a
resize, and supplies a live `SceneDocument` to the Hierarchy panel.
