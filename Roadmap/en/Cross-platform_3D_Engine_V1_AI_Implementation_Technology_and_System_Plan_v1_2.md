...
**Corresponding plan:** [`Cross-platform_3D_Engine_V1_Complete_Plan_v1_2.md`](Cross-platform_3D_Engine_V1_Complete_Plan_v1_2.md)

**Source:** [`../zh-TW/跨平台3D_Engine_V1_AI施工技術與系統規劃_v1_2.md`](../zh-TW/跨平台3D_Engine_V1_AI施工技術與系統規劃_v1_2.md)

## Document purpose

This edition turns the V1 architecture into implementation rules for AI-assisted engineering, code review, system decomposition, and CI. The complete plan is authoritative for product scope; this document is authoritative for implementation procedure. Existing public contracts and repository-local instructions override a generated implementation suggestion.
...
Implement a production-ready cross-platform foundation, including core runtime, stable gameplay ABI, scene and component architecture, rendering, assets, editor, UI, physics, animation, audio, video, and platform services. Preserve the architecture's central mechanism: Node + Component authoring backed by data-oriented runtime storage, a unified RHI for DX12/Vulkan/Metal, and deterministic content cooking.
...
Proceed through foundation; core/world; rendering and assets; gameplay systems; editor and tooling; platform hardening. Do not begin a dependent milestone until its schemas, interfaces, negative tests, instrumentation, and baseline performance evidence are accepted.
