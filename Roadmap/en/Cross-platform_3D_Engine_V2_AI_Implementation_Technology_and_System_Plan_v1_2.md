# Cross-platform 3D Engine — V2 AI Implementation Technology and System Plan

**English edition:** AI Technical Draft v1.2

**Corresponding plan:** [`Cross-platform_3D_Engine_V2_Complete_Plan_v1_4.md`](Cross-platform_3D_Engine_V2_Complete_Plan_v1_4.md)

**Source:** [`../zh-TW/跨平台3D_Engine_V2_AI施工技術與系統規劃_v1_2.md`](../zh-TW/跨平台3D_Engine_V2_AI施工技術與系統規劃_v1_2.md)

## Document purpose

This edition turns the V2 architecture into implementation rules for AI-assisted engineering, code review, system decomposition, and CI. The complete plan is authoritative for product scope; this document is authoritative for implementation procedure. Existing public contracts and repository-local instructions override a generated implementation suggestion.
...
Implement production-scale GPU-driven and connected-world capabilities, including GPUScene, GPU culling, temporal upscaling, virtual texturing, adaptive world partitioning, networking, advanced navigation/AI/animation/UI, distributed builds, and LiveOps. Preserve the architecture's central mechanism: content-addressable DDC, worker isolation, dedicated servers, replication/interest/prediction/replay, and remote diagnostics.
...
Proceed through V1 migration; reflection/DDC tooling; GPUScene; GPU-driven rendering; large worlds; networking; AI and animation; runtime features; distributed build and production hardening. Do not begin a dependent milestone until its schemas, interfaces, negative tests, instrumentation, and baseline performance evidence are accepted.
